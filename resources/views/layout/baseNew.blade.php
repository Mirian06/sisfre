...
<!-- Ocultando barra de navegação do menu(criado arquivo baseNew e referenciado na página de Login)
 ...
 @if (Route::has('login'))
    ...
    <footer class="welld navbar navbar-default footer" style="color:#000;">
